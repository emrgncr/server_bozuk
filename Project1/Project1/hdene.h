...
public:
	...
	void msg2dopl1() {
		if (pl1.set_efektsira(0, pl1.set_efektoynat(0, false), false) == 6) {
			if (s_yerekoyufak_p1(pl1.set_altisec(0, false), 6, pl1.set_field_secili(0, false)) == 0) {//RÝSK BUDUR
		...
		if (pl1.set_efektsira(0, pl1.set_efektoynat(0, false), false) == 7) {
			if (s_yerekoyufak_p1(pl1.set_yedisec(0, false), 7, pl1.set_field_secili(0, false)) == 0) {//RÝSK BUDUR
	...
	void msg2dopl2() {
		if (pl2.set_efektsira(0, pl2.set_efektoynat(0, false), false) == 6) {
			if (s_yerekoyufak_p2(pl2.set_altisec(0, false), 6, pl2.set_field_secili(0, false)) == 0) {//RÝSK BUDUR
		...
		if (pl2.set_efektsira(0, pl2.set_efektoynat(0, false), false) == 7) {
			if (s_yerekoyufak_p2(pl2.set_yedisec(0, false), 7, pl2.set_field_secili(0, false)) == 0) {//RÝSK BUDUR
	...
	void tur_hesapla(c_player o1, c_player o2, c_s_top cstop1[], int oy1, int oy2) {
		...
		//TUR AÞAMASI (ALLAH YARDIMCIM OLSUN)
		player_tur_asamasi(o1, o2, cstop1, oy1, oy2);

		//savaþ turu (sikerler bu sadece p1 þaka þaka p2 de var xd)
	...
	void s_efektler_p1(int olanefekt) {
		...
		case 8:
			...
			break;
			//999999999999999999999999999999999999BU ÇOK UZÝCAK AQ
		case 9:
...
c_player getpl2() {
	...
	int oyunbit_kontrol(c_player o1, c_player o2, c_s_top cstop1[], int oy1, int oy2) {
		//return : 0 = biþi yok / 1 = pl1 savaþla kazandý / 2 = pl2 savaþla kazandý / 3 = pl1 3 as yaparak kazandý / 4 = pl2 3 az yaparak kazandý
